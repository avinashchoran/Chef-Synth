    ...
    return (
        <header>
            ...
            <div className="header-right">
                <div className='eggflip-container' onClick={props.togglemode}>
                    <OmeletToggleSwitch isOn={props.isDark} />
                </div>
                <div
                    className="github-link"
                    style={{ cursor: "pointer" }}
                    onClick={() => window.open("https://github.com/avinashchoran/Chef-Synth", "_blank", "noopener,noreferrer")}
                >
